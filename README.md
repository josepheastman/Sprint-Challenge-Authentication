...
To allow a server to store information about a client, which can be used to persist authentication information across requests to the web page.

1. What does bcrypt do to help us store passwords in a secure manner.

It hashes passwords together with a unique randomly generated piece of input called salt.

1. What does bcrypt do to slow down attackers?

Bcrypt is configurable with a parameter that allows it perform an operation much like hashing many times, to be able to slow down an attackers attempts, and make it more difficult for them.
